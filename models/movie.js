...
exports.orderTicket = async (data) => {
    ...
    return new Promise((resolve, reject) => {
        let queries = `insert into orders(user_id, movie_name, watch_at, seat, ticket, price, payment_proof, created_at) values(${data.user_id},'${data.movie_name}', '${data.watch_at}', '${data.seat}', ${data.ticket}, ${data.total}, '${data.payment_proof_val}',NOW())`
